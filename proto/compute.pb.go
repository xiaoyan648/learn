...
import (
	types "github.com/xiaoyan648/learn/proto/types"
...
type Computer struct {
	...
	Cpu    *types.CPU    `protobuf:"bytes,2,opt,name=cpu,proto3" json:"cpu,omitempty"`
	Memory *types.Memory `protobuf:"bytes,3,opt,name=memory,proto3" json:"memory,omitempty"`
}
...
func (x *Computer) GetCpu() *types.CPU {
	if x != nil {
		return x.Cpu
	}
	return nil
...
func (x *Computer) GetMemory() *types.Memory {
	if x != nil {
		return x.Memory
	}
	return nil
...
var file_compute_proto_rawDesc = []byte{
	...
	0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x61, 0x73,
	0x73, 0x65, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x63, 0x0a, 0x08, 0x43, 0x6f, 0x6d,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x43,
	0x50, 0x55, 0x52, 0x03, 0x63, 0x70, 0x75, 0x12, 0x25, 0x0a, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72,
	0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e,
	0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x42, 0x16,
	0x5a, 0x14, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_compute_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_compute_proto_goTypes = []interface{}{
	(*Computer)(nil),     // 0: proto.Computer
	(*types.CPU)(nil),    // 1: types.CPU
	(*types.Memory)(nil), // 2: types.Memory
}
var file_compute_proto_depIdxs = []int32{
	1, // 0: proto.Computer.cpu:type_name -> types.CPU
	2, // 1: proto.Computer.memory:type_name -> types.Memory
